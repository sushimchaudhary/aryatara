//fetch data to filter position in ceo -------
...
//         {/* On mobile: image skeleton first */}
...
//               <div
//                 key={i}
//                 className={`h-3 bg-gray-200 rounded-full ${i === 5 ? "w-2/3" : "w-full"}`}
//               />
//             ))}
//           </div>
//         </div>
...
//         setCeo(team.find((m) => m.position.toLowerCase() === "ceo") ?? null);
...
//   const paragraphs = message?.description
...
//           On MOBILE:  image (order-1) comes first, text (order-2) comes second
//           On DESKTOP: text is left col (lg:order-1), image is right col (lg:order-2)
//         */}
//         <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
//           {/* ── LEFT on desktop / BOTTOM on mobile: Message text ── */}
//           <motion.div
...
//             <Quote
//               size={52}
//               className="text-green-100 -mb-4 shrink-0"
//               fill="currentColor"
//             />

//             {/* Paragraphs */}
//             <div className="space-y-4 text-gray-600 leading-relaxed text-[15px] text-justify">
...
//               <Quote
//                 size={36}
//                 className="text-green-100 rotate-180 shrink-0"
//                 fill="currentColor"
//               />
//             </div>
...
//           {/* ── RIGHT on desktop / TOP on mobile: CEO visual ── */}
//           <motion.div
//             initial={{ opacity: 0, x: 40 }}
//             whileInView={{ opacity: 1, x: 0 }}
//             viewport={{ once: true, amount: 0.1 }}
...
//                 style={{
//                   // 1. Wave/Blob shape using a complex border-radius
//                   borderRadius: "40% 60% 70% 30% / 40% 50% 60% 50%",

//                   // 2. Background with dot pattern
//                   backgroundColor: "#FFEA94", // Light yellow background
//                   backgroundImage: `radial-gradient(#22c55e 1.5px, transparent 1.5px)`,
//                   backgroundSize: "20px 20px", // Size of the dot grid

//                   // 3. Subtle animation to make it feel alive
//                   animation: "morph 2s ease-in-out infinite alternate",
//                 }}
//               >
//                 {/* Inject this into your global CSS or tailwind.config.js for the animation */}
//                 <style jsx>{`
//                   @keyframes morph {
//                     0% {
...
//                     }
//                     100% {
//                       border-radius: 30% 70% 40% 60% / 50% 40% 60% 40%;
//                     }
//                   }
//                 `}</style>
//               </div>
//               {/* Photo — static, no rotation */}
...
//                 {ceo?.position ?? "Chief Executive Officer"}
//               </p>
//             </motion.div>

//             {/* Dynamic stats — 2×2 on mobile, 4 cols on sm+ */}
...
//                 {paragraphs[0] ?? "A message of leadership and vision."}
//               </p>
...
//fetch data to order: 1 in chairman message -----
  ...
  useEffect(() => {
    async function fetchAll() {
      try {
        ...
        // ✅ Only pick the member with order === 1
        const featured = team.find((m) => m.order === 1) ?? null;
        setCeo(featured);
      ...
      <div className="max-w-7xl mx-auto md:px-12 px-4 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
          ...
          >
            ...
            {/* Signature strip — only shown if order===1 member exists */}
            {ceo && (
              <motion.div
                initial={{ opacity: 0, y: 16 }}
                whileInView={{ opacity: 1, y: 0 }}
